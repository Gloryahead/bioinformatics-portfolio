...
declare -a samples=(
    "SRR34070712" "SRR34070711" "SRR34070710"
    "SRR34070709" "SRR34070708" "SRR34070707"
)
...
if [ ! -f "$gene_annotation" ]; then
    ...
    curl -o "$hg38_genome_dir/Homo_sapiens.GRCh38.115.gff3.gz" \
    ...
    gunzip "$hg38_genome_dir/Homo_sapiens.GRCh38.115.gff3.gz"
    mv "$hg38_genome_dir/Homo_sapiens.GRCh38.115.gff3" "$gene_annotation"
...
for sample_id in "${samples[@]}"; do
    ...
    STAR --genomeDir "$STAR_index" \
         --runThreadN $THREADS \
         --readFilesIn "$trimmed_r1_gz" "$trimmed_r2_gz" \
